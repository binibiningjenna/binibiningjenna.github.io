    ...
    for (var i = 0; i < data.length; i++) {
      ...
      html +=
        '<div class="col-12 col-md-6 col-lg-4 mb-4">' +
          ...
          '<div class="card mb-3 scroll-animate" style="background-color: #333;">' +
            '<div class="card-body">';
      ...
      for (var j = 0; j < skills.length; j++) {
        ...
        html +=
          ...
          '<div class="progress mb-3">' +
            '<div class="progress-bar bg-warning text-dark subheading" style="width: ' + skillLevel + '%">' + skillLevel + '%</div>' +
          '</div>';
      }
